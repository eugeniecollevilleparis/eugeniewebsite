  ...
  en: {
    ...
    clients: {
      ...
      row1: [
        ...
        { type: "text", name: "VHNWI Families", event: "Household · travel", url: null },
    ...
    services: {
      ...
      items: [
        { n: "01", name: "Private Home Dining", desc: "Bespoke tasting menus prepared in your kitchen. Michelin-level cuisine, zero hosting stress." },
        { n: "02", name: "Events & Supperclubs", desc: "From intimate gatherings to 180+ guests. Fashion brands, gallery openings, magazine editors." },
        { n: "03", name: "Household Chef", desc: "Full or part-time for UHNWI and royal families. Daily menus, dietary management, travel included." },
        { n: "04", name: "Chalets & Villas", desc: "Seasonal placements in Courchevel, French Riviera and beyond. All meals, all diets." },
        { n: "05", name: "Nutrition & Wellness", desc: "Personalised nutrition plans. KETO, Vegan, Gluten-free, Coeliac — every diet expertly handled." },
        { n: "06", name: "Pâtisserie & Cakes", desc: "Award-recognised pastry expertise. Custom celebration cakes and refined dessert menus." },
        { n: "07", name: "Designer Events", desc: "Bespoke catering for fashion houses, design studios and luxury brands. Showroom dinners, runway after-parties, editorial showcases and brand activations — composed to match the universe of the house." },
      ],
    ...
    portfolio: {
      ...
      items: [
        { src: "/images/portfolio/chef-paris.jpg", title: "Plating in Paris", category: "Private Dining · Paris", span: "tall" },
        { src: "/images/hero.jpg", title: "Seared scallop, beurre blanc, caviar", category: "Private Dining", span: "wide" },
        { src: "/images/portfolio/duck-cherry.jpg", title: "Magret de canard, gratin & cerises", category: "Private Dining", span: "" },
        { src: "/images/portfolio/chef-cheffie-pot.jpg", title: "Eugénie at the pass", category: "Private Event · Paris", span: "tall" },
        ...
        { src: "/images/portfolio/tasting-duo.jpg", title: "Tasting menu duo", category: "Bespoke Event", span: "wide" },
  ...
  fr: {
    ...
    clients: {
      ...
      row1: [
        ...
        { type: "text", name: "Familles VHNWI", event: "Maison · voyage", url: null },
    ...
    services: {
      ...
      items: [
        { n: "01", name: "Dîners privés à domicile", desc: "Menus dégustation préparés dans votre cuisine. Gastronomie de niveau Michelin, zéro stress." },
        { n: "02", name: "Événements & Supperclubs", desc: "De réunions intimes à 180+ convives. Marques de mode, vernissages, rédactions de magazines." },
        { n: "03", name: "Cheffe de maison", desc: "Temps plein ou partiel pour familles UHNWI et royales. Menus quotidiens, gestion des régimes, déplacements inclus." },
        { n: "04", name: "Chalets & Villas", desc: "Missions saisonnières à Courchevel, Côte d'Azur et ailleurs. Tous repas, tous régimes." },
        { n: "05", name: "Nutrition & Bien-être", desc: "Plans nutritionnels personnalisés. KETO, Vegan, Sans gluten, Cœliaque — chaque régime maîtrisé." },
        ...
        { n: "07", name: "Événements Designer", desc: "Traiteur sur mesure pour maisons de mode, studios de design et marques de luxe. Dîners showroom, after-parties de défilé, événements éditoriaux et activations de marque — composés pour épouser l'univers de la maison." },
      ],
    ...
    portfolio: {
      ...
      items: [
        { src: "/images/portfolio/chef-paris.jpg", title: "Dressage à Paris", category: "Dîner privé · Paris", span: "tall" },
        { src: "/images/hero.jpg", title: "Saint-Jacques, beurre blanc, caviar", category: "Dîner privé", span: "wide" },
        { src: "/images/portfolio/duck-cherry.jpg", title: "Magret de canard, gratin & cerises", category: "Dîner privé", span: "" },
        { src: "/images/portfolio/chef-cheffie-pot.jpg", title: "Eugénie au pass", category: "Événement privé · Paris", span: "tall" },
        ...
        { src: "/images/portfolio/tasting-duo.jpg", title: "Duo menu dégustation", category: "Événement sur mesure", span: "wide" },
